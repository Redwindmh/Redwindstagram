    ...
    <div class="row">
        ...
        <div class="col-9 p-5">
            <div class="d-flex align-items-center justify-content-between">
                <h1>{{ $user->username }}</h1>
                <div>
                    <a href="/post/create"><button class="btn btn-dark btn-sm text-white fw-bold pt-1 pb-1 ms-3 mb-2 shadow-lg">+ Add new post</button></a></div>
            </div>
            <div class="d-flex">
            ...
            <div class="mt-3"><a href="/profile/{{$user->id}}/edit" class="text-small text-decoration-none text-dark">(edit profile)</a></div>
        </div>
        <div class="row pt-3">
